...
public class ArchmageEntity extends AbstractSpellCastingMob implements Enemy {
    ...
    public ArchmageEntity(Level level) {
        this(RegistryEntities.ARCHMAGE.get(), level);
    }
...
//    }
    ...
    protected void populateDefaultEquipmentSlots(RandomSource pRandom, DifficultyInstance pDifficulty) {
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(RegistryItems.ARCHMAGE_HEAD.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(RegistryItems.ARCHMAGE_CHEST.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(RegistryItems.ARCHMAGE_LEG.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(RegistryItems.ARCHMAGE_BOOTS.get()));
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RegistryItems.STAFF_OF_POWER.get()));
