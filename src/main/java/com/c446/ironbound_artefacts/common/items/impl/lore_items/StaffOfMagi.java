...
public class StaffOfMagi extends StaffItem implements IPresetSpellContainer {
    public static final ResourceLocation MARKOHESHKIR_ATTRIBUTE = IBA.p("markoheshkir_attribute");
    ...
    static {
        MarkoMap.put(SchoolRegistry.FIRE, RegistryEffects.FIRE_AFFINITY);
        MarkoMap.put(SchoolRegistry.ICE, RegistryEffects.ICE_AFFINITY);
        MarkoMap.put(SchoolRegistry.LIGHTNING, RegistryEffects.LIGHTNING_AFFINITY);
        MarkoMap.put(SchoolRegistry.NATURE, RegistryEffects.NATURE_AFFINITY);
    }
    ...
    public static class KereshkaFavor extends AbstractSpell {
        public final ResourceLocation spellId = IBA.p("kereshka_favor");
