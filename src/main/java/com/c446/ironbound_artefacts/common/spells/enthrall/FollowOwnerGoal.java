package com.c446.ironbound_artefacts.common.spells.enthrall;
...
public class FollowOwnerGoal extends Goal {
    ...
    public boolean canUse() {
        if (!mob.hasEffect(RegistryEffects.ENTHRALLED) || mob.getTarget() != null) return false;
        var charmInstance = mob.getEffect(RegistryEffects.ENTHRALLED);
