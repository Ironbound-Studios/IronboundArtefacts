...
public class TimeStopSpell extends AbstractSpell {
    private final DefaultConfig defaultConfig = new DefaultConfig()
            ...
            .build();
    private final ResourceLocation spellId = IBA.p("time_stop");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        entity.addEffect(new MobEffectInstance(RegistryEffects.TIME_STOP_CASTER, (int) this.getTickDuration(spellLevel, entity), spellLevel));
