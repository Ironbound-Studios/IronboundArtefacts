...
public class HeavenlyPunishment extends AbstractSpell {
    private final ResourceLocation loc = IronboundArtefact.prefix("lightning_immortal_art");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        entity.addEffect(new MobEffectInstance(EffectsRegistry.LIGHTNING_VOICE, 20*60*30,0));
