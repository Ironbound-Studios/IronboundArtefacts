...
import com.c446.ironbound_artefacts.common.entities.AstralCometEntity;
...
public class AstralCometRenderer extends FireballRenderer {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull Projectile pEntity) {
        return ResourceLocation.fromNamespaceAndPath(IBA.MODID, "textures/entities/comet.png");
    }
